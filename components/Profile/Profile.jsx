...
import { logoutSuccess, loadUpdateUserData, userSignUpData } from "@/redux/reducer/authSlice";
...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="mt-12 md:border md:py-6 md:px-4 md:rounded border-destructive/20 bg-destructive/5">
